...
namespace KurirskaSluzba
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "KurirskaSluzba", Version = "v1" });
            });
            ...
            services.AddAutoMapper(typeof(PaketProfile));
            services.AddScoped<IPaketRepository, PaketRepository>();
            services.AddScoped<IKurirRepository, KurirRepository>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "KurirskaSluzba v1"));
            }
